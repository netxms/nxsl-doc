...
* **Node** - A monitored device (server, router, switch)
* **Interface** - Network interface on a node
* **Subnet** - IP subnet containing nodes
* **Container** - Logical grouping of objects
* **Template** - Reusable configuration applied to nodes
* **Cluster** - Group of nodes acting as one
