...
[.version-added]
Added in version 5.2. [.version-added]#Additional constants added in version 6.0: `LocalManagement`, `NewPolicyTypes`, `ServiceManager`, `SSHInteractiveChannel`, `SSHCommandChannel`.#
